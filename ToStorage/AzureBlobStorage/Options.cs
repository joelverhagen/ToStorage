...
namespace Knapcode.ToStorage.AzureBlobStorage
{
    public class Options
    {
        ...
        [Option('f', "path-format", Required = true, HelpText = "The format to use when building the path.")]
        public string PathFormat { get; set; }

        [Option('t', "content-type", Required = false, HelpText = "The content type to set on the blob.")]
